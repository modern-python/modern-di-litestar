...
Specs, plans, and change history for `modern-di-litestar`. The living truth
...
- **[`architecture/`](../architecture/)** at the repo root — the living
  capability truth for the modern-di ↔ Litestar integration. This is the
  promotion target on every ship.
